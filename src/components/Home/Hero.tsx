          ...
          <div className={`${isRTL ? 'lg:order-2' : ''} animate-fade-in`}>
            ...
            <div className={`flex space-x-4 ${isRTL ? 'space-x-reverse' : ''}`}>
              <Link
                ...
                className="bg-[var(--primary-color)] text-[var(--card-bg-color)] px-6 py-3 rounded-xl font-semibold hover:bg-[var(--hover-bg-color)] transition-all duration-300 inline-flex items-center space-x-2 shadow-md hover:shadow-lg"
              ...
              <Link
                to="/about"
                className="border-2 border-[var(--border-color)] text-[var(--text-color)] px-6 py-3 rounded-xl font-semibold hover:bg-[var(--hover-bg-color)] hover:text-[var(--text-color)] transition-all duration-300 inline-flex items-center space-x-2 shadow-md hover:shadow-lg"
